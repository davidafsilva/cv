...
\begin{tabular}{L!{\VRule}R}
    ...
    {\small
        \begin{listing}
            \item Responsible for the product security processes, such as
            vulnerability and OSS management
            \item Responsible for define product security requirements and
    ...
    {\small
        \begin{listing}
            ...
            components of an \emph{SDN} platform
