...
\newacronym{oss}{OOS}{\emph{Open Source Software}}
...
My main programming language is \emph{Java}, specifically the SE flavour. Nevertheless i am also fluent in other programming languages such as \emph{C}, \emph{Python}, \emph{JavaScript} and \emph{Scala}.\\\\
